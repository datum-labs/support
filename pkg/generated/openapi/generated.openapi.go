...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntry":       schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntry(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntryList":   schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntryList(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntrySpec":   schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntrySpec(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntryStatus": schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntryStatus(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.ObjectReference":          schema_pkg_apis_support_v1alpha1_ObjectReference(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessage":           schema_pkg_apis_support_v1alpha1_SupportMessage(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessageList":       schema_pkg_apis_support_v1alpha1_SupportMessageList(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessageSpec":       schema_pkg_apis_support_v1alpha1_SupportMessageSpec(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessageStatus":     schema_pkg_apis_support_v1alpha1_SupportMessageStatus(ref),
		"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportTicket":            schema_pkg_apis_support_v1alpha1_SupportTicket(ref),
...
func schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntry(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KnowledgeBaseEntry is a reusable article in the support knowledge base.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntrySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntryStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntrySpec", "go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntryStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntryList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KnowledgeBaseEntryList contains a list of KnowledgeBaseEntry objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntry"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.KnowledgeBaseEntry", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntrySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KnowledgeBaseEntrySpec defines the content and metadata of a KB entry.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"title": {
						SchemaProps: spec.SchemaProps{
							Description: "Title is the human-readable title of the entry.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"body": {
						SchemaProps: spec.SchemaProps{
							Description: "Body is the entry content in Markdown format.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"topic": {
						SchemaProps: spec.SchemaProps{
							Description: "Topic categorizes the entry within the knowledge base.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tags": {
						SchemaProps: spec.SchemaProps{
							Description: "Tags are searchable labels attached to this entry.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"authorRef": {
						SchemaProps: spec.SchemaProps{
							Description: "AuthorRef identifies the staff member who created this entry.",
							Default:     map[string]interface{}{},
					...
					"sourceMessageRef": {
						SchemaProps: spec.SchemaProps{
							Description: "SourceMessageRef optionally tracks the SupportMessage this entry was promoted from.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"title", "body", "authorRef"},
			},
		},
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.UserReference"},
	}
}

func schema_pkg_apis_support_v1alpha1_KnowledgeBaseEntryStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KnowledgeBaseEntryStatus describes the observed state of a KnowledgeBaseEntry.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"createdAt": {
						SchemaProps: spec.SchemaProps{
					...
					"updatedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "UpdatedAt is the time the entry was last modified.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
				},
...
func schema_pkg_apis_support_v1alpha1_ObjectReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ObjectReference identifies a related Kubernetes-style object.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
							Description: "Kind is the type of the referenced object.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_pkg_apis_support_v1alpha1_SupportMessage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportMessage is a message within a SupportTicket conversation thread.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessageSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessageStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessageSpec", "go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessageStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_support_v1alpha1_SupportMessageList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportMessageList contains a list of SupportMessage objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessage"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportMessage", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_support_v1alpha1_SupportMessageSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportMessageSpec defines the content and metadata of a message.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"ticketRef": {
						SchemaProps: spec.SchemaProps{
							Description: "TicketRef is the name of the parent SupportTicket.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"body": {
						SchemaProps: spec.SchemaProps{
							Description: "Body is the message content in Markdown format.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"authorRef": {
						SchemaProps: spec.SchemaProps{
							Description: "AuthorRef identifies the user who wrote this message.",
							Default:     map[string]interface{}{},
							Ref:         ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.UserReference"),
						},
					},
					"authorType": {
						SchemaProps: spec.SchemaProps{
							Description: "AuthorType indicates whether the author is staff or a customer. Valid values: staff, customer.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"internal": {
						SchemaProps: spec.SchemaProps{
							Description: "Internal marks the message as a staff-only note not visible to customers.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
				},
				Required: []string{"ticketRef", "body", "authorRef", "authorType"},
			},
		},
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.UserReference"},
...
func schema_pkg_apis_support_v1alpha1_SupportMessageStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportMessageStatus describes the observed state of a SupportMessage.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"createdAt": {
						SchemaProps: spec.SchemaProps{
							Description: "CreatedAt is the time the message was created.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"updatedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "UpdatedAt is the time the message was last modified.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
				},
...
func schema_pkg_apis_support_v1alpha1_SupportTicket(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportTicket represents a customer support request.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportTicketSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportTicketStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportTicketSpec", "go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportTicketStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_support_v1alpha1_SupportTicketList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportTicketList contains a list of SupportTicket objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportTicket"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.miloapis.com/support/pkg/apis/support/v1alpha1.SupportTicket", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_support_v1alpha1_SupportTicketSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportTicketSpec defines the desired state of a SupportTicket.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"title": {
						SchemaProps: spec.SchemaProps{
							Description: "Title is the subject line of the support ticket.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"description": {
						SchemaProps: spec.SchemaProps{
							Description: "Description is the initial message body of the ticket.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status is the current state of the ticket. Valid values: open, in-progress, waiting-on-customer, resolved, closed.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"priority": {
						SchemaProps: spec.SchemaProps{
							Description: "Priority indicates the urgency of the ticket. Valid values: low, medium, high, urgent.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"ownerRef": {
						SchemaProps: spec.SchemaProps{
							Description: "OwnerRef identifies the staff member assigned to own this ticket.",
							Ref:         ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.UserReference"),
						},
					},
					"contributors": {
						SchemaProps: spec.SchemaProps{
							Description: "Contributors lists additional staff members working on the ticket.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"visibility": {
						SchemaProps: spec.SchemaProps{
							Description: "Visibility controls which operators can view this ticket. Valid values: all-staff.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"organizationRef": {
						SchemaProps: spec.SchemaProps{
							Description: "OrganizationRef identifies the organization this ticket belongs to.",
							Ref:         ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.ObjectReference"),
						},
					},
					"reporterRef": {
						SchemaProps: spec.SchemaProps{
							Description: "ReporterRef identifies the user who filed this ticket.",
							Default:     map[string]interface{}{},
							Ref:         ref("go.miloapis.com/support/pkg/apis/support/v1alpha1.UserReference"),
						},
					},
				},
				Required: []string{"title", "description", "reporterRef"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_support_v1alpha1_SupportTicketStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportTicketStatus describes the observed state of a SupportTicket.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase mirrors Spec.Status for field-selector queryability.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"ticketUid": {
						SchemaProps: spec.SchemaProps{
							Description: "TicketUID is a monotonically increasing integer assigned by the server at creation time. It is unique across all SupportTickets in the entire Milo system and never reused. Consumers may use it as a compact, human-friendly reference number (e.g. \"#42\"). The value is immutable once set.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"messageCount": {
						SchemaProps: spec.SchemaProps{
							Description: "MessageCount is the number of messages on this ticket.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"lastActivity": {
						SchemaProps: spec.SchemaProps{
							Description: "LastActivity is the timestamp of the most recent message or update.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"readState": {
...
func schema_pkg_apis_support_v1alpha1_UserReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserReference identifies a user (staff or customer).",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the unique identifier of the user.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"displayName": {
						SchemaProps: spec.SchemaProps{
							Description: "DisplayName is the human-readable name of the user.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
