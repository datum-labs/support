...
export const com_miloapis_notes_v1alpha1_ClusterNoteSchema = {
  description:
...
export const com_miloapis_notes_v1alpha1_ClusterNoteListSchema = {
  description: 'ClusterNoteList is a list of ClusterNote',
  type: 'object',
  required: ['items'],
  properties: {
    apiVersion: {
    ...
    items: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/com.miloapis.notes.v1alpha1.ClusterNote',
      },
    },
    kind: {
      description:
...
export const com_miloapis_notes_v1alpha1_NoteSchema = {
  description:
...
export const com_miloapis_notes_v1alpha1_NoteListSchema = {
  ...
  properties: {
    ...
    items: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/com.miloapis.notes.v1alpha1.Note',
      },
    },
    kind: {
      description:
