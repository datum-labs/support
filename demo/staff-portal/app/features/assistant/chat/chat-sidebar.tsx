  ...
  return (
    <div
      ...
      <div className="border-muted-foreground/10 border-b px-3 py-2">
        <p className="text-foreground truncate text-xs font-medium">Patch AI</p>
      </div>
      ...
      <p className="text-muted-foreground/40 border-muted-foreground/10 mt-auto shrink-0 border-t px-3 py-2 text-[10px]">
